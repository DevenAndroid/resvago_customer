...
class _HomePageState extends State<HomePage> {
  ...
  getSliders() {
    FirebaseFirestore.instance
        .collection("slider")
        .orderBy('timestamp', descending: isDescendingOrder)
        .get()
        .then((value) {
  ...
  getVendorCategories() {
    FirebaseFirestore.instance
        ...
        .where("deactivate", isNotEqualTo: true)
        .get()
        .then((value) {
      for (var element in value.docs) {
        var gg = element.data();
  ...
  String _calculateDistance({dynamic lat1, dynamic lon1}) {
    ...
    double distanceInMeters = Geolocator.distanceBetween(
        double.parse(lat1),
        double.parse(lon1),
        double.parse(locationController.lat.toString()),
        double.parse(locationController.long.toString()));
                ...
                StreamBuilder<List<RestaurantModel>>(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      List<RestaurantModel> resturent = snapshot.data ?? [];
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text(
                                          restaurantListItem.restaurantName
                                              .toString(),
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Text(
                                          _calculateDistance(
                                            lat1: restaurantListItem.latitude
                                                .toString(),
                                            lon1: restaurantListItem.longitude
                                                .toString(),
                                          ),
                                          style: GoogleFonts.poppins(
                                              fontSize: 14,
  ...
  List<RestaurantModel> filterUsers(List<RestaurantModel> users, String query) {
    if (query.isEmpty) {
      return users;
    } else {
